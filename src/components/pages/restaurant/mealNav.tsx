...
const MealNav = () => {
  ...
  return (
    <nav className='meal-nav'>
      ...
      <Link
        to={`${mainRestaurantPath}searchMeal`}
        style={{
          backgroundColor: setCustomBgColor(currentPage, 'search-meal'),
        }}
      >
        Search Meal
      </Link>
      <Link
        to={`${mainRestaurantPath}favourite`}
        style={{ backgroundColor: setCustomBgColor(currentPage, 'favourite') }}
      >
        Favourite meal
      </Link>
      <Link
        to={`${mainRestaurantPath}categories`}
        style={{ backgroundColor: setCustomBgColor(currentPage, 'categories') }}
      >
        Categories
      </Link>
    </nav>
